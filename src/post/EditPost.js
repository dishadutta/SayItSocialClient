  ...
  editPostForm = (title, body) => (
    <form>
      <div className="form-group">
        <label className="text-dark">Post Photo</label>
      ...
      <button onClick={this.clickSubmit} type="button" className="btn btn-raised btn-primary">Update Post</button>
    </form>
  );
  ...
  render () {
    ...
    return (
      <div className="container">
        <h2 className="mt-5 mb-5 lead">{title}</h2>
